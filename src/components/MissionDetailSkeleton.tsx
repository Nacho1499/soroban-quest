...
/**
 * MissionDetailSkeleton component
 * Displays a loading skeleton for mission detail page content
 *
 * @returns {React.ReactElement} Skeleton loading state
 */
export default function MissionDetailSkeleton(): React.ReactElement {
  return (
